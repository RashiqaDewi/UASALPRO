...
def filter_products():
    ...
    bobot = {"SkinType" : 0.1 , "Label" : 0.1, 'Harga': 0.5, "Rank": 0.5}
    if not filtered_df.empty:
        ...
        if not filtered_df.empty:
            ...
            normalized_df['Rank'] = bobot['Rank'] * (normalized_df['Rank'] / normalized_df['Rank'].max())
            ...
            sorted_products = filtered_df.sort_values(by= ['NilaiKedekatan'], ascending=[True])
        ...
        message = "Tidak ada produk yang aman untuk Anda."
